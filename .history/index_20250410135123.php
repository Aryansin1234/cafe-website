...
<section class="py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <img src="<?php echo htmlspecialchars($item['image_url']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" class="w-full h-48 object-cover object-center">
            <div class="p-6">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative h-[400px]">
                <img src="assets/images/about-img.jpg" alt="Cafe Ambiance" class="w-full h-full object-cover object-center rounded-lg shadow-lg">
            </div>
        </div>
    </div>
</section>
