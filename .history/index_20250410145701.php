...
<!-- Hero Section -->
<div class="relative min-h-[600px] -mt-6">
    <div class="absolute inset-0">
        <img src="assets/images/hero-bg1.jpg" alt="Cafe Interior" class="w-full h-full object-cover object-center">
        <div class="absolute inset-0 bg-black opacity-40"></div>
    </div>
    <div class="relative max-w-7xl mx-auto min-h-[600px] flex items-center px-4 py-20">
