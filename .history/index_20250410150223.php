...
<div class="relative w-full overflow-hidden -mt-6">
    <div class="w-full min-h-[200px] md:min-h-[400px]">
        <img src="assets/images/hero-bg1.jpg" alt="Cafe Interior" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black bg-opacity-40"></div>
    </div>
    <div class="absolute inset-0 flex items-center">
        <div class="max-w-7xl mx-auto px-4 w-full py-12">
